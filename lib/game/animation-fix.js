...
.defines(function(){ "use strict";
    ...
    ig.Animation.inject({
        ...
        draw: function( targetX, targetY ) {
            ...
            var rotatedWidth = Math.sin(angle) * this.sheet.height + Math.cos(angle) * this.sheet.width;
            var rotatedHeight = Math.sin(angle) * this.sheet.width + Math.cos(angle) * this.sheet.height;
